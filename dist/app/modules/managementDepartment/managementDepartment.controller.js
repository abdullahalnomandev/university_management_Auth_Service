...
const createManagementDepartment = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield managementDepartment_service_1.ManagementDepartmentService.createManagement(
...
const getAllManagementDepartments = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield managementDepartment_service_1.ManagementDepartmentService.getAllManagements(
        filters,
        paginationOption
      );
    (0, sendResponse_1.default)(res, {
...
const getSingleManagementDepartment = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result =
      yield managementDepartment_service_1.ManagementDepartmentService.getSingleManagement(
        req.params.id
      );
    (0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
...
const updateManagementDepartment = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const data = req.body;
    const result =
      yield managementDepartment_service_1.ManagementDepartmentService.updateManagement(
        id,
        data
      );
    (0, sendResponse_1.default)(res, {
