...
const getSingleStudent = (semesterId) => __awaiter(void 0, void 0, void 0, function* () {
...
const updateStudent = (studentId, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return yield student_model_1.Student.findOneAndUpdate({ id: studentId }, updatedStudentData, {
        new: true,
    });
});
const deleteStudent = (semesterId) => __awaiter(void 0, void 0, void 0, function* () {
