...
const getAllFaculty = (filters, paginationOption) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const count = yield academicFaculty_model_1.AcademicFaculty.countDocuments();
    if (page) {
        if (skype > count)
...
const updateFaculty = (facultyId, payload) => __awaiter(void 0, void 0, void 0, function* () {
    return yield academicFaculty_model_1.AcademicFaculty.findOneAndUpdate({ _id: facultyId }, payload, {
        new: true,
    });
});
const deleteFaculty = (semesterId) => __awaiter(void 0, void 0, void 0, function* () {
    return yield academicFaculty_model_1.AcademicFaculty.findByIdAndDelete(semesterId);
});
