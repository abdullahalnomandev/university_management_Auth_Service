...
const getAllAdmin = (filters, paginationOption) => __awaiter(void 0, void 0, void 0, function* () {
...
const getSingleAdmin = (facultyId) => __awaiter(void 0, void 0, void 0, function* () {
    return yield admin_model_1.Admin.findById(facultyId).populate('managementDepartment');
});
const updateAdmin = (adminId, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return yield admin_model_1.Admin.findOneAndUpdate({ id: adminId }, updateAdminData, {
        new: true,
    });
});
const deleteAdmin = (adminId) => __awaiter(void 0, void 0, void 0, function* () {
    const faculty = yield admin_model_1.Admin.findByIdAndDelete(adminId).populate('managementDepartment');
